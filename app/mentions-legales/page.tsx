...
export const metadata: Metadata = {
  title: "Mentions légales — ARCHI PILOTE",
      ...
      <section className="relative pb-24 md:pb-36">
        <div className="container-site max-w-[42rem] mx-auto flex flex-col gap-10 text-ivoire/85 text-[0.98rem] leading-relaxed">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ARCHI PILOTE est une marque de pilotage de projets de rénovation, exploitée par IA RENOV (SASU).
              ARCHI PILOTE n&apos;est pas une entreprise de travaux, n&apos;exécute aucun lot et ne facture aucun
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              droit d&apos;auteur. Les visuels de la galerie et des réalisations, tant qu&apos;ARCHI PILOTE n&apos;a
