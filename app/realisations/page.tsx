...
const DEROULE = [
  ...
  { src: `${CH}/chPortiqueAcierAngleMurDegarni2.jpeg`, alt: "Gaine électrique et câblage repassés le long d'une poutre acier de reprise de charge après ouverture d'un mur porteur", cap: "Autre chantier réel : gaine électrique et câblage repassés le long d'une poutre acier de reprise de charge, après ouverture d'un mur porteur et avant habillage par le plaquiste." },
