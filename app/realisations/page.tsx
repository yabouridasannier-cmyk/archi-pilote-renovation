...
const DEROULE = [
  ...
  { src: `${CH}/chPoutreAcierSoudureAngle2.jpeg`, alt: "Angle soudé entre poutre et poteau acier de reprise de charge, plafond ouvert avant habillage", cap: "Autre chantier réel : angle soudé entre poutre et poteau acier de reprise de charge, plafond ouvert avant habillage par le plaquiste." },
...
const COMPARAISONS = [
  ...
  /* À GÉNÉRER : les deux images stock ci-dessous montrent deux cuisines sans rapport
     (styles, pièces et agencements différents), pas un avant/après cohérent d'un même
     lieu — contrairement à ce qu'un curseur avant/après implique. À remplacer par une
     vraie paire cohérente. Prompt avant : "Photo réaliste d'une cuisine en cours de
     rénovation, caissons standards blancs déjà montés sans aucune façade ni poignée,
     plan de travail brut posé, pièce claire, lumière naturelle, format 4:3." Prompt
     après : "La même cuisine terminée, façades en chêne massif à cannelures verticales
     installées sur les caissons existants, poignées intégrées, plan de travail identique
     conservé, même pièce et même luminosité que la photo avant, format 4:3." */
  { titre: "Caissons standards, façades sur mesure", texte: "Les caissons standards sont conservés et optimisés ; seules les façades, les plinthes et les habillages sont fabriqués sur mesure, ce qui réduit fortement le coût à rendu équivalent.", avant: `${M}/cuisine-caissons-facades-sur-mesure.jpg`, apres: `${M}/cuisine-renovee-vert-sauge.jpg`, avantLabel: "Avant — caissons optimisés", apresLabel: "Après — cuisine livrée", note: "Deux illustrations distinctes (styles différents), pas un avant/après du même lieu — en attente d'une vraie paire cohérente." },
